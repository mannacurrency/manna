...
namespace Checkpoints
{
    ...
    // manna: synchronized checkpoint (centrally broadcasted)
    ...
    // manna: get last synchronized checkpoint
    ...
    // manna: only descendant of current sync-checkpoint is allowed
    ...
    // manna: reset synchronized checkpoint to last hardened checkpoint
...
// manna: sync-checkpoint master key
...
// manna: verify signature of sync-checkpoint message
...
// manna: process synchronized checkpoint
